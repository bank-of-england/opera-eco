...
```json
{
  ...
  "signatures": {
    ...
    "forecast_evaluation.ForecastData": "(outturns_data: pandas.DataFrame | None = None, forecasts_data: pandas.DataFrame | None = None, load_fer: bool | None = False, *, extra_ids: list[str] | None = None, metric: Literal['levels', 'pop', 'yoy'] = 'levels', compute_levels: bool = True, data_check: bool = True, outturn_vintages: bool = True, default_k: int | None = None, first_forecast_horizon: int | dict[str, int] | None = None)",
    "forecast_evaluation.NowcastData": "(outturns_data: pandas.DataFrame | None = None, forecasts_data: pandas.DataFrame | None = None, *, extra_ids: list[str] | None = None, metric: Literal['levels', 'pop', 'yoy'] = 'levels', compute_levels: bool = True, data_check: bool = True, default_k: int | None = None, first_forecast_horizon: int | dict[str, int] | None = None)",
    ...
    "forecast_evaluation.bias_analysis": "(data: forecast_evaluation.data.ForecastData.ForecastData, source: None | str | list[str] = None, variable: None | str | list[str] = None, k: int | None = None, same_date_range: bool = True, verbose: bool = False) -> forecast_evaluation.tests.results.TestResult",
    ...
    "forecast_evaluation.compute_accuracy_statistics": "(data: forecast_evaluation.data.ForecastData.ForecastData, source: None | str | list[str] = None, variable: None | str | list[str] = None, k: int | None = None, same_date_range: bool = True) -> forecast_evaluation.tests.results.TestResult",
    "forecast_evaluation.compute_intra_period_accuracy": "(data: pandas.DataFrame | forecast_evaluation.data.ForecastData.ForecastData, variable: str, metric: Literal['levels', 'pop', 'yoy'] = 'levels', frequency: Literal['Q', 'M'] = 'Q', horizon: int | None = None, statistic: Literal['rmse', 'mae'] = 'rmse', k: int | None = None, axis: Literal['period_end', 'publication'] = 'period_end') -> pandas.DataFrame",
    "forecast_evaluation.compute_intra_period_bias": "(data: pandas.DataFrame | forecast_evaluation.data.ForecastData.ForecastData, variable: str, metric: Literal['levels', 'pop', 'yoy'] = 'levels', frequency: Literal['Q', 'M'] = 'Q', horizon: int | None = None, k: int | None = None, axis: Literal['period_end', 'publication'] = 'period_end') -> pandas.DataFrame",
    ...
    "forecast_evaluation.core.build_main_table": "(forecasts: pandas.DataFrame, outturns: pandas.DataFrame, id_columns: list[str], variables: str | list[str] | None = None, forecast_ids: str | list[str] | None = None, frequency: Literal['Q', 'M'] = 'Q', *, outturn_vintages: bool = True) -> pandas.DataFrame",
    ...
    "forecast_evaluation.forecast_errors_correlation_analysis": "(data: forecast_evaluation.data.ForecastData.ForecastData, source: None | str | list[str] = None, variable: None | str | list[str] = None, k: int | None = None, same_date_range: bool = True, min_observations: int = 5) -> forecast_evaluation.tests.results.TestResult",
    "forecast_evaluation.plot_accuracy": "(df: pandas.DataFrame | ForwardRef('TestResult'), variable: str, metric: Literal['levels', 'pop', 'yoy'], frequency: Literal['Q', 'M'] | None = None, statistic: Literal['rmse', 'rmedse', 'mse', 'mean_abs_error'] = 'rmse', convert_to_percentage: bool = False, return_plot: bool = False)",
    "forecast_evaluation.plot_average_revision_by_period": "(data, source, variable, metric, frequency=None, return_plot: bool = False)",
    "forecast_evaluation.plot_bias_by_horizon": "(df: pandas.DataFrame | ForwardRef('TestResult'), variable: str, source: str, metric: Literal['levels', 'pop', 'yoy'], frequency: Literal['Q', 'M'] | None = None, convert_to_percentage: bool = False, return_plot: bool = False)",
    "forecast_evaluation.plot_blanchard_leigh_ratios": "(results: pandas.DataFrame | ForwardRef('TestResult'), return_plot: bool = False)",
    ...
    "forecast_evaluation.plot_correlation_heatmap": "(df: pandas.DataFrame | ForwardRef('TestResult'), variable: str, metric: Literal['levels', 'pop', 'yoy'], horizon: int, frequency: Literal['Q', 'M'] | None = None, cmap: str = 'RdBu_r', annotate: bool = True, return_plot: bool = False)",
    "forecast_evaluation.plot_errors_across_time": "(data: forecast_evaluation.data.ForecastData.ForecastData, variable: str, metric: Literal['levels', 'pop', 'yoy'], error: Literal['raw', 'absolute', 'squared'] = 'raw', horizons: int | list[int] | None = None, sources: str | list[str] | None = None, frequency: Literal['Q', 'M'] | None = None, k: int = 12, ma_window: int = 1, show_mean: bool = True, convert_to_percentage: bool = False, return_plot: bool = False, custom_labels: dict | None = None, existing_plot: tuple | None = None) -> tuple | None",
    "forecast_evaluation.plot_forecast_error_density": "(data: forecast_evaluation.data.ForecastData.ForecastData, variable: str, horizon: int, metric: Literal['levels', 'pop', 'yoy'], source: str, frequency: Literal['Q', 'M'] | None = None, k: int = 12, highlight_dates: str | list[str] | None = None, highlight_vintages: str | list[str] | None = None, return_plot: bool = False)",
    ...
    "forecast_evaluation.plot_forecast_errors_by_horizon": "(data: forecast_evaluation.data.ForecastData.ForecastData, variable: str, source: str | list[str], metric: Literal['levels', 'pop', 'yoy'], frequency: Literal['Q', 'M'] | None = None, k: int = 12, convert_to_percentage: bool = False, return_plot: bool = False)",
    "forecast_evaluation.plot_hedgehog": "(data: forecast_evaluation.data.ForecastData.ForecastData, variable: str, forecast_source: str, metric: Literal['levels', 'pop', 'yoy'], frequency: Literal['Q', 'M'] | None = None, k: int = 12, date_start: str | datetime.date | None = None, convert_to_percentage: bool = False, return_plot: bool = False, releases: list[int] | None = None) -> tuple[matplotlib.figure.Figure, matplotlib.axes._axes.Axes] | None",
    "forecast_evaluation.plot_intra_period_accuracy": "(data: pandas.DataFrame | ForwardRef('ForecastData'), variable: str, metric: Literal['levels', 'pop', 'yoy'] = 'levels', frequency: Literal['Q', 'M'] = 'Q', horizon: int | None = None, statistic: Literal['rmse', 'mae'] = 'rmse', k: int | None = None, axis: Literal['period_end', 'publication'] = 'period_end', convert_to_percentage: bool = False, confidence_level: int | None = None, return_plot: bool = False)",
    "forecast_evaluation.plot_intra_period_bias": "(data: pandas.DataFrame | ForwardRef('ForecastData'), variable: str, metric: Literal['levels', 'pop', 'yoy'] = 'levels', frequency: Literal['Q', 'M'] = 'Q', horizon: int | None = None, k: int | None = None, axis: Literal['period_end', 'publication'] = 'period_end', convert_to_percentage: bool = False, confidence_level: int | None = None, return_plot: bool = False)",
    ...
    "forecast_evaluation.plot_radar": "(df: pandas.DataFrame | ForwardRef('TestResult') | ForwardRef('ForecastData'), mode: Literal['metrics', 'variables', 'tests'], *, variable: str | None = None, variables: list[str] | None = None, metric: str | None = None, horizon: int | None = None, frequency: Literal['Q', 'M'] | None = None, statistic: Literal['rmse', 'rmedse', 'mean_abs_error'] = 'rmse', k: int = 12, test_type: Literal['accuracy', 'bias', 'efficiency', 'correlation'] = 'accuracy', bias_type: Literal['mean', 'mz'] = 'mean', efficiency_type: Literal['revision_predictability', 'revisions_errors'] = 'revision_predictability', anchor_source: str | None = None, normalise: bool = True, individual_scales: bool = False, return_plot: bool = False)",
    ...
    "forecast_evaluation.plot_rolling_correlation": "(df: pandas.DataFrame | ForwardRef('TestResult'), variable: str, anchor_source: str, horizons: int | list[int], metric: Literal['levels', 'pop', 'yoy'] | None = None, frequency: Literal['Q', 'M'] | None = None, return_plot: bool = False)",
    ...
    "forecast_evaluation.plot_strong_efficiency": "(results: pandas.DataFrame | ForwardRef('TestResult'), return_plot: bool = False)",
    ...
    "forecast_evaluation.revision_predictability_analysis": "(data: forecast_evaluation.data.ForecastData.ForecastData, variable: str | list[str] | None = None, source: None | str | list[str] = None, frequency: Literal['Q', 'M'] | None = None, n_revisions: Annotated[int, Gt(gt=0)] = 5, same_date_range: bool = True) -> forecast_evaluation.tests.results.TestResult",
    "forecast_evaluation.revisions_errors_correlation_analysis": "(data: forecast_evaluation.data.ForecastData.ForecastData, source: None | str | list[str] = None, variable: None | str | list[str] = None, k: int | None = None, same_date_range: bool = True) -> forecast_evaluation.tests.results.TestResult",
    ...
    "forecast_evaluation.tests.bias_analysis": "(data: forecast_evaluation.data.ForecastData.ForecastData, source: None | str | list[str] = None, variable: None | str | list[str] = None, k: int | None = None, same_date_range: bool = True, verbose: bool = False) -> forecast_evaluation.tests.results.TestResult",
    ...
    "forecast_evaluation.tests.compute_accuracy_statistics": "(data: forecast_evaluation.data.ForecastData.ForecastData, source: None | str | list[str] = None, variable: None | str | list[str] = None, k: int | None = None, same_date_range: bool = True) -> forecast_evaluation.tests.results.TestResult",
    "forecast_evaluation.tests.compute_intra_period_accuracy": "(data: pandas.DataFrame | forecast_evaluation.data.ForecastData.ForecastData, variable: str, metric: Literal['levels', 'pop', 'yoy'] = 'levels', frequency: Literal['Q', 'M'] = 'Q', horizon: int | None = None, statistic: Literal['rmse', 'mae'] = 'rmse', k: int | None = None, axis: Literal['period_end', 'publication'] = 'period_end') -> pandas.DataFrame",
    "forecast_evaluation.tests.compute_intra_period_bias": "(data: pandas.DataFrame | forecast_evaluation.data.ForecastData.ForecastData, variable: str, metric: Literal['levels', 'pop', 'yoy'] = 'levels', frequency: Literal['Q', 'M'] = 'Q', horizon: int | None = None, k: int | None = None, axis: Literal['period_end', 'publication'] = 'period_end') -> pandas.DataFrame",
    ...
    "forecast_evaluation.tests.forecast_errors_correlation_analysis": "(data: forecast_evaluation.data.ForecastData.ForecastData, source: None | str | list[str] = None, variable: None | str | list[str] = None, k: int | None = None, same_date_range: bool = True, min_observations: int = 5) -> forecast_evaluation.tests.results.TestResult",
    "forecast_evaluation.tests.revision_predictability_analysis": "(data: forecast_evaluation.data.ForecastData.ForecastData, variable: str | list[str] | None = None, source: None | str | list[str] = None, frequency: Literal['Q', 'M'] | None = None, n_revisions: Annotated[int, Gt(gt=0)] = 5, same_date_range: bool = True) -> forecast_evaluation.tests.results.TestResult",
    "forecast_evaluation.tests.revisions_errors_correlation_analysis": "(data: forecast_evaluation.data.ForecastData.ForecastData, source: None | str | list[str] = None, variable: None | str | list[str] = None, k: int | None = None, same_date_range: bool = True) -> forecast_evaluation.tests.results.TestResult",
    ...
    "forecast_evaluation.tests.weak_efficiency_analysis": "(data: forecast_evaluation.data.ForecastData.ForecastData, source: None | str | list[str] = None, variable: None | str | list[str] = None, k: int | None = None, same_date_range: bool = True, verbose: bool = False) -> forecast_evaluation.tests.results.TestResult",
    ...
    "forecast_evaluation.visualisations.plot_accuracy": "(df: pandas.DataFrame | ForwardRef('TestResult'), variable: str, metric: Literal['levels', 'pop', 'yoy'], frequency: Literal['Q', 'M'] | None = None, statistic: Literal['rmse', 'rmedse', 'mse', 'mean_abs_error'] = 'rmse', convert_to_percentage: bool = False, return_plot: bool = False)",
    ...
    "forecast_evaluation.visualisations.plot_bias_by_horizon": "(df: pandas.DataFrame | ForwardRef('TestResult'), variable: str, source: str, metric: Literal['levels', 'pop', 'yoy'], frequency: Literal['Q', 'M'] | None = None, convert_to_percentage: bool = False, return_plot: bool = False)",
    "forecast_evaluation.visualisations.plot_blanchard_leigh_ratios": "(results: pandas.DataFrame | ForwardRef('TestResult'), return_plot: bool = False)",
    ...
    "forecast_evaluation.visualisations.plot_correlation_heatmap": "(df: pandas.DataFrame | ForwardRef('TestResult'), variable: str, metric: Literal['levels', 'pop', 'yoy'], horizon: int, frequency: Literal['Q', 'M'] | None = None, cmap: str = 'RdBu_r', annotate: bool = True, return_plot: bool = False)",
    "forecast_evaluation.visualisations.plot_errors_across_time": "(data: forecast_evaluation.data.ForecastData.ForecastData, variable: str, metric: Literal['levels', 'pop', 'yoy'], error: Literal['raw', 'absolute', 'squared'] = 'raw', horizons: int | list[int] | None = None, sources: str | list[str] | None = None, frequency: Literal['Q', 'M'] | None = None, k: int = 12, ma_window: int = 1, show_mean: bool = True, convert_to_percentage: bool = False, return_plot: bool = False, custom_labels: dict | None = None, existing_plot: tuple | None = None) -> tuple | None",
    "forecast_evaluation.visualisations.plot_forecast_error_density": "(data: forecast_evaluation.data.ForecastData.ForecastData, variable: str, horizon: int, metric: Literal['levels', 'pop', 'yoy'], source: str, frequency: Literal['Q', 'M'] | None = None, k: int = 12, highlight_dates: str | list[str] | None = None, highlight_vintages: str | list[str] | None = None, return_plot: bool = False)",
    ...
    "forecast_evaluation.visualisations.plot_forecast_errors_by_horizon": "(data: forecast_evaluation.data.ForecastData.ForecastData, variable: str, source: str | list[str], metric: Literal['levels', 'pop', 'yoy'], frequency: Literal['Q', 'M'] | None = None, k: int = 12, convert_to_percentage: bool = False, return_plot: bool = False)",
    "forecast_evaluation.visualisations.plot_hedgehog": "(data: forecast_evaluation.data.ForecastData.ForecastData, variable: str, forecast_source: str, metric: Literal['levels', 'pop', 'yoy'], frequency: Literal['Q', 'M'] | None = None, k: int = 12, date_start: str | datetime.date | None = None, convert_to_percentage: bool = False, return_plot: bool = False, releases: list[int] | None = None) -> tuple[matplotlib.figure.Figure, matplotlib.axes._axes.Axes] | None",
    "forecast_evaluation.visualisations.plot_intra_period_accuracy": "(data: pandas.DataFrame | ForwardRef('ForecastData'), variable: str, metric: Literal['levels', 'pop', 'yoy'] = 'levels', frequency: Literal['Q', 'M'] = 'Q', horizon: int | None = None, statistic: Literal['rmse', 'mae'] = 'rmse', k: int | None = None, axis: Literal['period_end', 'publication'] = 'period_end', convert_to_percentage: bool = False, confidence_level: int | None = None, return_plot: bool = False)",
    "forecast_evaluation.visualisations.plot_intra_period_bias": "(data: pandas.DataFrame | ForwardRef('ForecastData'), variable: str, metric: Literal['levels', 'pop', 'yoy'] = 'levels', frequency: Literal['Q', 'M'] = 'Q', horizon: int | None = None, k: int | None = None, axis: Literal['period_end', 'publication'] = 'period_end', convert_to_percentage: bool = False, confidence_level: int | None = None, return_plot: bool = False)",
    ...
    "forecast_evaluation.visualisations.plot_radar": "(df: pandas.DataFrame | ForwardRef('TestResult') | ForwardRef('ForecastData'), mode: Literal['metrics', 'variables', 'tests'], *, variable: str | None = None, variables: list[str] | None = None, metric: str | None = None, horizon: int | None = None, frequency: Literal['Q', 'M'] | None = None, statistic: Literal['rmse', 'rmedse', 'mean_abs_error'] = 'rmse', k: int = 12, test_type: Literal['accuracy', 'bias', 'efficiency', 'correlation'] = 'accuracy', bias_type: Literal['mean', 'mz'] = 'mean', efficiency_type: Literal['revision_predictability', 'revisions_errors'] = 'revision_predictability', anchor_source: str | None = None, normalise: bool = True, individual_scales: bool = False, return_plot: bool = False)",
    ...
    "forecast_evaluation.visualisations.plot_rolling_correlation": "(df: pandas.DataFrame | ForwardRef('TestResult'), variable: str, anchor_source: str, horizons: int | list[int], metric: Literal['levels', 'pop', 'yoy'] | None = None, frequency: Literal['Q', 'M'] | None = None, return_plot: bool = False)",
    ...
    "forecast_evaluation.visualisations.plot_strong_efficiency": "(results: pandas.DataFrame | ForwardRef('TestResult'), return_plot: bool = False)",
    ...
    "forecast_evaluation.weak_efficiency_analysis": "(data: forecast_evaluation.data.ForecastData.ForecastData, source: None | str | list[str] = None, variable: None | str | list[str] = None, k: int | None = None, same_date_range: bool = True, verbose: bool = False) -> forecast_evaluation.tests.results.TestResult"
  },
  "version": "0.1.13"
}
```
